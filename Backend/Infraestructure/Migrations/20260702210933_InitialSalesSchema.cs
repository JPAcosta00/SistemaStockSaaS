    ...
    public partial class InitialSalesSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Tenants",
                columns: new[] { "Id", "BusinessName", "CreatedAt", "IsActive", "Name" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), "Central SRL", new DateTime(2026, 7, 2, 21, 9, 32, 653, DateTimeKind.Utc).AddTicks(1401), true, "Supermercado Central" });
